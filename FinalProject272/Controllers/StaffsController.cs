...
namespace FinalProject272.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StaffId,Name,Age,Position")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffId,Name,Age,Position")] Staff staff)
        {
            if (ModelState.IsValid)
            {
